...
# Classes/Functions below have been adapted from https://github.com/mwaskom/seaborn/blob/master/seaborn/matrix.py
...
class ClusterGridPhylogeny(ClusterGrid):
    ...
    def __init__(
        ...
        if _no_skbio:
            raise RuntimeError("ClusterGridPhylogeny requires scikit-bio be available")
...
def clustermap_phylo(
    ...
    **kwargs,
    ...
    """
    if _no_skbio:
        raise RuntimeError("clustermap_phylo requires scikit-bio be available")
...
def dendrogram_phylo(
    ...
    *,
    ...
    if _no_skbio:
        raise RuntimeError("DendrogramPhylo requires scikit-bio be available")
